...
public class RegisterVolunteerActivity extends AppCompatActivity {
    ...
    Button registerVolunteerButton, registerVolunteerBackButton, removeVolunteerButton;
    TextView locationNameTextView, locationOwnerTextView, durationTextView, eventDateTextView, messageTextView;
...
//        });
        ...
        isDisplayRemove(false,false, "Register to become a volunteer");


//        Check if the user is the owner of the location----------------------------------
        if(userId.equals(locationOwner)){
            isDisplayRemove(true,false, "You are the owner of this location");
        ...
        volunteerRef.get().addOnCompleteListener(task -> {
            if(task.isSuccessful()) {
                ...
                if(volunteeredLocationList != null && volunteeredLocationList.contains(locationId)) {
                    isDisplayRemove(true,true, "You have already registered to this location");
...
//        Button for Owner Remove Location  -------------------------------------------------
...
//    Support function display button


//    Support function display text
    private void isDisplayRemove(boolean bool, boolean isUnregister, String text){ //true to display text notifying the owner and registered user
        if(bool){
            if(isUnregister){
